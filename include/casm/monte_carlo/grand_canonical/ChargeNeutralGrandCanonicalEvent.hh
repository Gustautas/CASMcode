...
class ChargeNeutralGrandCanonicalEvent {
	public:
  	...
  	private:
    	...
    	std::tuple<Eigen::VectorXl,Eigen::VectorXl> m_dN;
  ...
  inline ChargeNeutralGrandCanonicalEvent::ChargeNeutralGrandCanonicalEvent(size_type Nspecies, size_type Ncorr){
	  ...
	  inline std::tuple<double,double> ChargeNeutralGrandCanonicalEvent::dEf() const {
	    return m_dEf;
	  }
	  ...
	  // Gustas: changed pair to vector
	  inline std::tuple<Eigen::VectorXl,Eigen::VectorXl> &ChargeNeutralGrandCanonicalEvent::dN() {
	    return m_dN;
	  }
	  /// \brief const Access change in number of all species (extensive). Order as in CompositionConverter::components().
	  inline const std::tuple<Eigen::VectorXl,Eigen::VectorXl> &ChargeNeutralGrandCanonicalEvent::dN() const {
	    return m_dN;
	  }
